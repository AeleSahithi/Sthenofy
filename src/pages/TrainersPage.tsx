...
const trainers = [
  { name: 'Marcus Reid', specialty: 'Head Strength Coach', exp: '12 years', certs: ['NSCA-CSCS', 'USAW Level 2'], bio: 'Former national powerlifting champion. Marcus has coached over 300 competitive lifters and specializes in raw strength development.', img: 'https://images.pexels.com/photos/13211450/pexels-photo-13211450.jpeg?auto=compress&cs=tinysrgb&h=650&w=940' },
  { name: 'Sarah Chen', specialty: 'Yoga & Mobility', exp: '8 years', certs: ['RYT-500', 'FRC Mobility Specialist'], bio: 'Doctor of Physical Therapy turned yoga instructor. Sarah blends clinical knowledge with mindful movement for lasting results.', img: 'https://images.pexels.com/photos/31245340/pexels-photo-31245340.jpeg?auto=compress&cs=tinysrgb&h=650&w=940' },
  { name: 'James Okoro', specialty: 'HIIT & Conditioning', exp: '10 years', certs: ['NASM-CPT', 'Precision Nutrition L1'], bio: 'Ex-military fitness instructor. James brings discipline and energy to every session, pushing you past your perceived limits.', img: 'https://images.pexels.com/photos/13885345/pexels-photo-13885345.jpeg?auto=compress&cs=tinysrgb&h=650&w=940' },
  { name: 'Lisa Park', specialty: 'Pilates & Core', exp: '7 years', certs: ['STOTT Pilates', 'NASM-CPT'], bio: 'Former professional dancer. Lisa helps clients build long, lean strength and perfect posture through controlled movement.', img: 'https://images.pexels.com/photos/20649585/pexels-photo-20649585.jpeg?auto=compress&cs=tinysrgb&h=650&w=940' },
  { name: 'Diego Santos', specialty: 'Combat & Boxing', exp: '15 years', certs: ['USA Boxing Coach', 'Muay Thai Kru'], bio: 'Retired professional boxer with 30+ fights. Diego teaches technique, discipline, and the mental toughness of a fighter.', img: 'https://images.pexels.com/photos/10305231/pexels-photo-10305231.jpeg?auto=compress&cs=tinysrgb&h=650&w=940' },
  { name: 'Emma Foster', specialty: 'Olympic Lifting', exp: '9 years', certs: ['USAW Level 3', 'CrossFit L3'], bio: 'National-level Olympic weightlifter. Emma breaks down complex movements into simple, safe progressions for any level.', img: 'https://images.pexels.com/photos/30246174/pexels-photo-30246174.jpeg?auto=compress&cs=tinysrgb&h=650&w=940' },
];
